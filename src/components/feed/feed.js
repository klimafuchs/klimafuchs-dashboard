											...
											<Row className="align-items-end my-1" key={post.node.id}>
												...
												<Col xs="12" lg="12">
													...
													>
														...
														{post.node.isPinned ? <span className="text-center text-primary font-italic font-weight-bold">Pinned Content</span> : null}

														{post.node.image == null ? null : <CardImg top width="100%" src={`${img_url}/${post.node.image.filename}`} alt="Card image cap" />}
														...
														<span className="annotation font-italic">
															...
															<Time value={post.node.dateCreated} format="DD.MM.YYYY hh:mm:ss"></Time>
														</span>
													</Card>
												</Col>

												<Comments passed_refetch={() => refetch(FEED)} comments={post.node.comments} />
